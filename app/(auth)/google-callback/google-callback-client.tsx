...
function GoogleCallbackHandler() {
	...
	useEffect(() => {
		...
		auth.login(accessToken).then(() => {
			...
			// Full navigation, not router.replace() — see dang-nhap-client.tsx's
			// onSubmit for why: `next` can carry a stale pre-login prefetch that
			// router.refresh() doesn't reach. .replace() (not .href): don't keep
			// this token-bearing URL in history.
