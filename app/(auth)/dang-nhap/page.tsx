...
function LoginForm() {
	...
	// Where to land after a successful login — set by whatever protected link
	// sent the visitor here (see AGENTS.md → Layout decisions, the
	// sign-in-gate note). Falls back to home since nothing sends this yet;
	// nothing today points here WITH a `next`, this is just where that wiring
